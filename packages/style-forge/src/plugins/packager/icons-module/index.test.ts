...
import { iconsModulePackagerPlugin } from '.';
...
const expectedResult = [
  ...
  {
    path: 'dist/icons-module/icon-test-2.js',
    content:
      "import React, { forwardRef } from 'react';\r\n" +
      '\r\n' +
      '\r\n' +
      'export const IconTest2 = forwardRef(function (_ref, ref) {\r\n' +
      '  const params = {};\r\n' +
      '  for (const key of Object.keys(_ref)) {\r\n' +
      '    params[key] = _ref[key];\r\n' +
      '  }\r\n' +
...
describe('Test Icons Module Packager Plugin', () => {
  it('produces expected data', () => {
    const result = iconsModulePackagerPlugin().runFileCreation(iconData);
