...
import { iconsFilePackagerPlugin } from '.';
import * as os from 'os';

const expectedResult = [
  {
    path: 'src/icons/icon-test-1.js',
    content:
  ...
  {
    path: 'src/icons/icon-test-2.js',
    content:
      "import React from 'react';" +
      os.EOL +
      '' +
      os.EOL +
      'export const IconTest2 = (props) => {' +
      os.EOL +
      `  return <svg {...props}>` +
      os.EOL +
      "    <g clipPath='url(#clip0_8102_4924)'>" +
      os.EOL +
...
describe('Test Icons Module Packager Plugin', () => {
  it('produces expected data', () => {
    const result = iconsFilePackagerPlugin().runFileCreation(iconData);
